# Google Apps Script Specification: WBS Automation v0.0.7

This document details the implemented functionality and automation rules for the `gasWbsTimelineViewAgent` script. This version introduces automated cell color-coding for visual grouping of tasks and fixes an issue where the entire row's background was being colored.
...
*   **Execution**:
    ...
    *   Triggers the color-coding logic automatically when a value in the `Object` column (Column A) or `Resource` column (Column F) is changed.
...
|---|---|---|---|
| A | **Object** | String | **Manual Input:** The name of the project or target. **This column now drives cell color-coding.** |
| ... | ... | ... | ... |
| F | **Resource** | String | **Manual Input:** The person or team assigned. **This column now drives cell color-coding.** |
| ... | ... | ... | ... |
